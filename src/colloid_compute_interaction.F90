           ...
           IF ( this%cc_lub_type == mcf_cc_lub_type_first .OR. &
              ...
              DO i = 1, num_p-1
                 ...
                 DO j = i+1, num_p
                    ...
                    !********* Changed by Adolfo (magnetic forces). If necessary change this *********
                    ! (look at colloid_compute_interaction_implicit_velocity_pair.F90
                    IF ( this%cc_magnet_type == mcf_cc_magnet_type_field ) THEN

                       r12(1:dim) = x_p(1:dim,i) - x_p(1:dim,j)
...
!!$                            sid_p(i),sid_p(j),F_ij(1:dim),stat_info_sub)
                          ...
                          T_p(1:dim,i) = T_p(1:dim,i) + T_ij(1:dim)
                          T_p(1:dim,j) = T_p(1:dim,j) + T_ji(1:dim)
              ...
              DO i = 1, num_p
                 ...
                 DO j = 1, num_p_ghost
                    ...
                    IF ( this%cc_magnet_type == mcf_cc_magnet_type_field ) THEN
                       ...
                       r12(1:dim) = x_p(1:dim,i) - x_p_ghost(1:dim,j)
                       r = SQRT(DOT_PRODUCT(r12(1:dim), r12(1:dim)))
                       IF ( r <= this%cc_magnet_cut_off ) THEN
