	...
	!----------------------------------------------------
        ...
        REAL(MK),DIMENSION(:,:),POINTER :: magnet_mom
        !**********************************************
	...
	!----------------------------------------------------
        ...
        !*********** Added by Adolfo (magnetic) *************
        CALL colloid_get_magnet_mom(d_colloid,magnet_mom,stat_info_sub)
        !****************************************************
...
!****************************************************
        ...
        output(j_start:j_end,1:num_colloid) = &
             magnet_mom(1:num_dim,1:num_colloid)
        !*******************************************************
...
9999    CONTINUE
        ...
        !*********** Added by Adolfo (magnetic) ***********
        IF(ASSOCIATED(magnet_mom)) THEN
           DEALLOCATE(magnet_mom)
        END IF
        !**************************************************
